...
public class SeerRecordNumberRule extends NaaccrDataGeneratorRule {
    ...
    private static final String _CRITERIA = "For each patient, each tumor is given a SEER Record Number starting at 01, incrementing by 1 for each additional tumor.";
